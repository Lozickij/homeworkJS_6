...
// const cardLink = cardBody.querySelectorAll('.card-link');
// for (let i = 0; i < cardLink.length; i++) { 
//     console.log(cardLink[i]);
//     }
...
// titleElText = titleEl.textContent;
// console.log(titleElText);
